            ...
            <template #icon>
              ...
              <template v-if="error.fullname !== undefined" #message-danger>
         	  ...
         	  <vs-select
		        ...
		        block class="mb-3"
		      >
		        <vs-option label="Grade 6" value="Grade 6">
		          Grade 6
		        </vs-option>
		        <vs-option label="Grade 7" value="Grade 7">
		          Grade 7
		        </vs-option>
		        <vs-option label="Grade 8" value="Grade 8">
		          Grade 8
		        </vs-option>
		        <vs-option label="Grade 9" value="Grade 9">
		          Grade 9
		        </vs-option>
		        <vs-option label="Grade 10" value="Grade 10">
		          Grade 10
		        </vs-option>
